...
from ..ops.block_sparse_flash_attention import block_sparse_attention, pyramidkv_attention, snapkv_attention
...
def gather_pyramidkv_topk_vllm(self, q, k, v, head_id, layer_idx):
    ...
    def pyramidkv_kernel(q, k, v, layer_id:int, vertical_size=None, slash_size=None):
        return pyramidkv_attention(q, k, v, layer_id)
        # return snapkv_attention(q, k, v, layer_id)
