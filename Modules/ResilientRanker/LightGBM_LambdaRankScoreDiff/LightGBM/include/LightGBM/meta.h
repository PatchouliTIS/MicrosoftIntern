...
// add definitions for set used in doc pairs
using doc_id_t = int64_t;
using DocPair = std::pair<doc_id_t, doc_id_t>;
using DocPairComparator = bool (*) (const DocPair&, const DocPair&);
using DocPairContainer = std::set<DocPair, DocPairComparator>;

// c++98 style definition
//typedef bool (*DocPairComparator) (std::pair<int, int>);
//typedef std::set<std::pair<int, int>, DocPairComparator> DocPairContainer;
