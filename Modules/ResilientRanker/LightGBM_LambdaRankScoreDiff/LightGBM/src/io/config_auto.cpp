...
const std::unordered_map<std::string, std::string>& Config::alias_table() {
  ...
  {"impression_id", "impression_id_column"},
  {"imp_id", "impression_id_column"},
  {"metrics", "metric"},
  {"metric_types", "metric"},
...
const std::unordered_set<std::string>& Config::parameter_set() {
  ...
  "rankdiff_alpha",
  "doc_id_column",
  "impression_id_column",
  "normalize_gradient_scorediff",
  "metric",
  "metric_freq",
...
void Config::GetMembersFromString(const std::unordered_map<std::string, std::string>& params) {
  ...
  GetBool(params, "dump_bin_boundary", &dump_bin_boundary);
  ...
  GetDouble(params, "scorediff_beta", &scorediff_beta);
  CHECK_GE(scorediff_beta, 0.0);

  GetDouble(params, "rankdiff_alpha", &rankdiff_alpha);
  CHECK_GE(rankdiff_alpha, 0.0);

  GetString(params, "doc_id_column", &doc_id_column);

  GetString(params, "impression_id_column", &impression_id_column);

  GetBool(params, "normalize_gradient_scorediff", &normalize_gradient_scorediff);
...
std::string Config::SaveMembersToString() const {
  ...
  str_buf << "[dump_bin_boundary: " << dump_bin_boundary << "]\n";
  ...
  str_buf << "[doc_id_column: " << doc_id_column << "]\n";
  str_buf << "[impression_id_column: " << impression_id_column << "]\n";
  str_buf << "[normalize_gradient_scorediff: " << normalize_gradient_scorediff << "]\n";
